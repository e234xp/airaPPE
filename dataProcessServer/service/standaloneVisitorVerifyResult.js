...
class standaloneVisitorVerifyResult {
    constructor(workingFolder) {
        const self = this;
        self._fileHeader = "vvr";
        self._workingDBFolder = workingFolder + "/visitorverifyresult";
        self._workingPhotoDBFolder = workingFolder + "/visitorverifyresultphoto";
        self._run = true;
...
module.exports = standaloneVisitorVerifyResult;
