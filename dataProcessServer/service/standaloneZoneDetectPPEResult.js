...
class standaloneZoneDetectPPEResult {
    constructor(workingFolder) {
        const self = this;
        self._fileHeader = "zdp";
        self._workingDBFolder = workingFolder + "/verifyresult";
        // self._workingPhotoDBFolder = workingFolder + "/verifyresultphoto";
        self._run = true;
...
module.exports = standaloneZoneDetectPPEResult;
